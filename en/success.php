...
<head>
    ...
    <meta itemprop="name" content="Successful Registration">
...
?>
   ...
   <div class="warlord">
         ...
         <div class="container-fluid" style="min-height:73.2%; background-color: #e9f5f5;">
            ...
            <br>
            <div class="row>">
                <h1 class="newh" style="text-align: center;">Successful Registration !</h1>

                <br><br><br>
                <div class="form">
   <link rel="apple-touch-icon" href="../img/favicon-32x32.png" />
                            
               <p class="message"><strong>You registered successfuly!</strong><br><br>
               <p class="message"><strong>Press here to Login </strong><a href='login.php'>Login</a>

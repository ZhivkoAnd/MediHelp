...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="../img/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../img/favicon-16x16.png">
     <link rel="canonical" href="https://www.medihelp.center/en/registration.php">
    ...
    <meta name="description" content="Register and Login into the Medihelp system.">
    <meta name="keywords" content="Register, Registration, Medical Center Medihelp Register">
   <link rel="apple-touch-icon" href="../img/favicon-32x32.png" />
    <title>Register | Medical Center Medihelp</title>

    <meta itemprop="name" content="Register | Medical Center Medihelp">
    <meta itemprop="description" content="Register and Login into the Medihelp system.">
    ...
    <div class="warlord">
         ...
         <div class="container-fluid" style="min-height:73.2%; background-color: #e9f5f5;">
            ...
            <div class="row">
                ...
                <h1 class="newh" style="text-align:center;">Registration</h1> <br><br><br>
                <div class="form">
                    ...
                    <form name="registration" action="" method="post">
                        ...
                        <p class="message"><strong>Already have an account ? </strong><br><br>
                            <a href="login.php"><strong>Click here to login</strong></a></p>
                    </form>
                </div>

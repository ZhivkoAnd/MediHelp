...
<head>
   ...
   <link rel="icon" type="image/png" sizes="32x32" href="../img/favicon-32x32.png">
    ...
    <link rel="canonical" href="https://www.medihelp.center/en/contacts.php">
   ...
   <link rel=”alternate” href="https://www.medihelp.center/en/contacts.php" hreflang="en" />
    <title>Contacts | Primorsko | Medical Center Medihelp</title>
    <meta itemprop="name" content="Contacts | Primorsko | Medical Center Medihelp">
    <meta itemprop="description" content="Contact us on telephone: 00359887411608 | Working Hours: Everyday from 8:00 to 20:00.">
   ...
   <link rel="apple-touch-icon" href="../img/favicon-32x32.png" />
    ...
    <meta name="description" content="Contact us on telephone: 00359887411608 | Working Hours: Everyday from 8:00 to 20:00.">
    <meta name="keywords" content="Medical Center Medihelp contacts, Medical Center Primorsko contacts, Medical Center Medihelp Telephone, Medical Center Primorsko telephone">
...
<body data-spy="scroll">
  ...
  <div class="warlord">
       ...
       <div class="container-fluid" style="background-color: #e9f5f5;">
            <div class="inside">
            <h1 id="kontakti" class="newh">Contacts</h1>
            <div class="kontakt">
                <div class="jumbotron">
                    <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 ">
                            ...
                            <h2 class="sredni"> <span class="glyphicon glyphicon-home"></span>&nbsp;&nbsp;Address:</h2>
                            <p class="textt">
                                Bulgaria  <br>
                                Primorsko <br>
                                 MMC Complex of hotels<br>
                                Les Magnolias Club Hotel</p>

                            <h2 class="sredni"><span class="glyphicon glyphicon-phone-alt"></span>&nbsp;&nbsp;Call us on:</h2>
                            <p class="textt">
                                Medical hot line:&nbsp;<strong><i><span style="color:#990000;text-decoration:underline;font-family:'Russo One';letter-spacing:1px;"><a href="tel:+359887411608">00359887411608</a></span></i></strong> <br>
                                 Information and contacts:&nbsp;<strong><i><span style="color:#990000;text-decoration:underline;font-family:'Russo One';letter-spacing:1px;"><a href="tel:+359898939421">00359898939421</a></span></i></strong>
                            </p>
                            <h2 class="sredni"> <span class="glyphicon glyphicon-briefcase"></span>&nbsp;&nbsp;Working hours<br></h2>
                            <p class="textt"> Everyday from 8:00 to 22:00</p>
                            <h2 class="sredni"> <span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp; Contact us in:</h2>
                            <p class="textt"> Bulgarian;&nbsp;English;&nbsp;Russian;</p>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 ">
                            ...
                            <h2 class="sredni"> <span class="glyphicon glyphicon-bell"></span>&nbsp;&nbsp; Ask us anything here:</h2><br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="form_lastname" type="text" name="surname" class="form-control" placeholder="Surname *" required="required" data-error="Surname is required.">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="form_need" name="need" class="form-control" required="required" data-error="Please, choose a category.">
                                                        <option value=""></option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="form_message" name="message" class="form-control" placeholder="Message *" rows="4" required="required" data-error="Please, write a message."></textarea>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                            ...
                            <?php }else{ ?>
                         <!--   <p class="textt"> <strong style="font-size:19px; color:#990000;"> <span class="glyphicon glyphicon-alert"></span>&nbsp;&nbsp; You have to Login first.</strong></p><br> -->
                            <div class="formbg">
                                <form id="contact-form" method="post" action="contact.php" role="form">
                   ...
                   <div class="udebelen" ; style="text-align:center">Please, do not hesitate to contact us with any medical questions you may have. <br>Our doctors serve Burgas, Primorsko, Kiten, Lozenec, Sozopol and Tsarevo. </div><br><br>
                    <div class="map">

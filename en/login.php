...
<head>
    ...
    <link rel="canonical" href="https://www.medihelp.center/en/login.php">
    ...
    <meta name="description" content="Login into the Medihelp system">
    <meta name="keywords" content="Medical Center Medihelp Login, Medical Center Medihelp account">
   <link rel="apple-touch-icon" href="../img/favicon-32x32.png" />
    <title>Login | Medical Center Medihelp</title>
    <meta itemprop="name" content="Login | Medical Center Medihelp">
    <meta itemprop="description" content="Login into the Medihelp system">
...
?>
  ...
  <div class="warlord">
          ...
          <div class="container-fluid" style="min-height:73.2%; background-color: #e9f5f5;">
            ...
            <br>
            <div class="row>">
                <h1 class="newh" style="text-align: center;">Login</h1>
                ...
                <div class="form">
                    ...
                    <form class="login-form" action="" method="post" name="login">
                        ...
                        <p class="message"><strong>You don't have an account ? </strong>
                            <br><br>
                            <a href='registration.php'><strong>Register here !</strong></a></p>
                    </form>
                </div>

...
<head>
    ...
    <link rel="canonical" href="https://www.medihelp.center/sitemap.php">
    ...
    <title>Kaрта на сайта | Медицински Център Медихелп</title>
    <meta itemprop="name" content="Kaрта на сайта | Медицински Център Медихелп">
    <meta name="description" content="Медицински Център Медихелп карта на сайта.">
    ...
    <meta itemprop="description" content="Медицински Център Медихелп карта на сайта.">
    <meta name="keywords" content="карта на сайт, Медицински Център Медихелп карта на сайта">
    <!-- Styles -->
    ...
    <div class="warlord">
        ...
        <div class="container-fluid" style="min-height:73.2%; background-color: #e9f5f5;">
            <div class="inside">
                ...
                <h1 id="zanas" class="newh" style="border-bottom: 3px solid black;">Карта на Сайта</h1>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <h2 class="sredni"><a href="index.php"><span style="color:black; font-size:27px;">Начало</span></a></h2><br>
                        <h2 class="sredni"><span style="color:black;  font-size:27px;">Хирургии</span></h2>
                        <p class="textt" style="font-family:'Philosopher'; font-weight:bold; font-size:19px; ">
                            <a href="koremna-hirurgia.php"> &nbsp;&nbsp; <span style="color:black; font-size:22px;">• Коремна Хирургия</span></a><br>
                            <a href="plastichna-hirurgia.php"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> • Пластична Хирургия</span></a><br>
                            <a href="ugolemiavane-na-gurdi.php"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> &nbsp;&nbsp; - Уголемяване на гърди</span></a><br>
                            <a href="ugolemiavane-na-ustni.php"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> &nbsp;&nbsp; - Уголемяване на устни</span></a><br>
                               <a href="liposukcia.php"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> &nbsp;&nbsp; - Липосукция</span></a><br>
                            <a href="kolorektalna-hirurgia.php"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> • Колоректална Хирургия</span></a><br>
                            <a href="kolonoskopia.php"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> • Колоноскопия</span></a><br>
                            <a href="gastroskopia.php"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> • Гастроскопия</span> </a><br>


                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <h2 class="sredni"><a href="kontakti.php"><span style="color:black; font-size:27px;"> Контакти</span></a></h2><br>
                        <h2 class="sredni"><a href="za-nas.php"><span style="color:black; font-size:27px;">За Нас</span></a></h2>
                        <p class="textt" style="font-family:'Philosopher'; font-weight:bold; font-size:19px; ">
                            <a href="#"> &nbsp;&nbsp; <span style="color:black;font-size:22px;">• Доктори</span></a><br>
                            <a href="#"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> • Оборудване</span></a><br>
                            <a href="#"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> • Такси и застраховки</span></a><br><br></p>
                        <h2 class="sredni"><span style="color:black; font-size:27px;"> Галерия</span></h2>
                        <p class="textt" style="font-family:'Philosopher'; font-weight:bold; font-size:19px; ">
                            <a href="galeria.php"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> • Снимки</span></a><br>
                            <a href="virtualna-realnost.php"> &nbsp;&nbsp;<span style="color:black;font-size:22px;"> • VR Картина</span> </a><br>
                        </p>

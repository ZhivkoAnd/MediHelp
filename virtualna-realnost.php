...
<head>
    ...
    <link rel="canonical" href="https://www.medihelp.center/virtualna-realnost.php">
    ...
    <meta name="description" content="Разгледайте медицинския център отвътре с новата ни Виртуална Реалност.">
    <meta name="keywords" content="Виртуална реалност, Медицински център Виртуална реалност">
   <link rel="apple-touch-icon" href="img/favicon-32x32.png" />
    <title>Виртуална Реалност | Медицински Център Медихелп</title>

    <meta itemprop="name" content="Виртуална Реалност | Медицински Център Медихелп">
    <meta itemprop="description" content="Разгледайте медицинския център отвътре с новата ни Виртуална Реалност.">
    ...
    <meta property="og:description" content="Виртуална реалност" />
    ...
    <footer class="site-footer" style="background-color:transparent;">
        <div class="container-fluid">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <p style="font-size:2rem; color:black; font-family:'Philosopher'; font-weight:bold;">Посочете с мишката една от трите картини за триизмерен образ</p><br>

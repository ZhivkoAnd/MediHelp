...
<head>
   ...
   <link rel="apple-touch-icon" href="img/favicon-32x32.png" />
    ...
    <meta itemprop="name" content="Неуспешно влизане">
...
<br/>Опитайте отново от <a href='login.php'>Тук</a></div>";
	}
    }else{
?>
 ...
 <div class="warlord">
   ...
   <div class="inside">
            <br>
            <div class="row>">
                <h2 class="newh" style="text-align: center;">Неуспешно влизане</h2>

                <br><br><br>
                <div class="form">
                    <p class="message"><strong>Паролата или името са неправилни</strong><br><br>
                        <p class="message"><strong><a href='login.php'>Опитайте отново от тук</a></strong>

...
<head>
    ...
    <link rel="canonical" href="https://www.medihelp.center/registration.php">
    <link rel=”alternate” href="https://www.medihelp.center/registration.php" hreflang="bg" />
    <link rel=”alternate” href="https://www.medihelp.center/en/registration.php" hreflang="en" />
    <meta name="description" content="Регистрирайте се и влезте в системата на Медихелп">
    <meta name="keywords" content="Регистрация, Медицински Център Медихелп Регистрация">
   <link rel="apple-touch-icon" href="img/favicon-32x32.png" />
    <title>Регистрация | Медицински Център Медихелп</title>

    <meta itemprop="name" content="Медицински Център Медихелп - Регистрация">
    <meta itemprop="description" content="Регистрирайте се и влезте в системата на Медихелп">
...
VALUES ('$username', '".md5($password)."', '$email', '$trn_date')";
        ...
        if($result){
           echo ("<script>location.href = 'uspeshna-registracia.php';</script>");
        }
    }else{
?>
     <!-- NAVIGATION -->
...
<div class="container-fluid" style="min-height:73.2%; background-color: #e9f5f5;">
   <div class="inside">
            ...
            <div class="row">
                <div class="container-fluid">
                    <h1 class="newh" style="text-align:center; border-bottom:3px solid black;">Регистрация</h1> <br>
                    <div class="form">
                        ...
                        <form name="registration" action="" method="post">
                            ...
                            <p class="message">Вече имаш Регистрация ? <br><br>
                                <a href="#">Влез от тук</a></p>
                        </form>
                    </div>
                </div>
            </div>

...
<head>
   ...
   <link rel="apple-touch-icon" href="img/favicon-32x32.png" />
    ...
    <meta itemprop="name" content="Успешна Регистрация">
...
and password='".md5($password)."'";
	...
	echo "<div class='form'>
<h3>Името или паролата са неправилни.</h3>
<br/>Опитайте отното от  <a href='login.php'>Тук</a></div>";
	}
    }else{
?>
...
<div class="container-fluid" style="min-height:73.2%; background-color: #e9f5f5;">
   <div class="inside">
            <br>
            <div class="row>">
                <h2 class="newh" style="text-align: center;">Регистрацията е успешна</h2>

                <br><br><br>
                <div class="form">

                            
               <p class="message"><strong>Вие се регистрирахте успешно !</strong><br><br>
               <p class="message"><strong>Влезте в профила си от </strong><a href='login.php'>Тук</a>
